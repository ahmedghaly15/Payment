...
class EphemeralKeyResponseBody {
  String? id;
  String? object;
  ...
  factory EphemeralKeyResponseBody.fromJson(Map<String, dynamic> json) {
    return EphemeralKeyResponseBody(
